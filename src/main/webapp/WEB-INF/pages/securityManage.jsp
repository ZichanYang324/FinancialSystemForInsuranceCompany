...
<script type="text/javascript">
	...
	function openSecurityAddDialog() {
		$("#dlg").dialog("open").dialog("setTitle", "添加保单信息");
	...
	function openSecurityModifyDialog() {
		...
		$("#dlg").dialog("open").dialog("setTitle", "编辑保单信息");
		$('#fm').form('load', row);
	...
	function openSecurityFindDialog(){
		...
		var row=selectedRows[0];
		$("#finddlg").dialog("open").dialog("setTitle","查看保单信息");
...
<body style="margin: 1px;">
	<table id="dg" title="保单管理" class="easyui-datagrid" fitColumns="true"
		...
		<thead>
			<tr>
				...
				<th field="username" width="100" align="center" sortable="true">开户人</th>
				<th field="securityname" width="100" align="center" sortable="true">保单账号</th>
				<th field="securitypassward" width="100" align="center"  sortable="true">开户人身份证号</th>
				<th field="company" width="100" align="center" sortable="true">保险名称</th>
				<th field="datadicvalue" width="100" align="center" sortable="true">保单类型</th>
				<th field="starttime" width="100" align="center" sortable="true">保单有效开始时间</th>
				<th field="endtime" width="100" align="center" sortable="true">保单有效截止时间</th>
	...
	<div id="tb">
		...
		<div>
			&nbsp;开户人：&nbsp;<input type="text" id="s_username" size="12" onkeydown="if(event.keyCode==13) searchSecurity()" />
			&nbsp;保险名称：&nbsp;<input type="text" id="s_company" size="12" onkeydown="if(event.keyCode==13) searchSecurity()" />
			&nbsp;保单类型：&nbsp;<select class="easyui-combobox" id="s_dataid" editable="false" style="width: 100px;">
				<option value="">请选择...</option>
				<c:forEach items="${securitys }" var="security">
					<option value="${security.id }">${security.datadicvalue }</option>
				</c:forEach>
			</select>&nbsp;
			&nbsp;保单有效期：&nbsp;<input type="text" id="s_searchStarttime" class="easyui-datetimebox" size="18" onkeydown="if(event.keyCode==13) searchSecurity()"/>
