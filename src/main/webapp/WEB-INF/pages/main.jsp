...
<body class="easyui-layout">
	<div region="north" style="height: 78px;">
		<table style="padding: 5px" width="100%">
			<tr>
				<td width="20%"><%--<img
					src="${basePath}resource/images/mylogo.png" />--%></td>
	...
	<div region="west" style="width: 200px" title="导航菜单" split="true">
		<div class="easyui-accordion" data-options="fit:true,border:false">
			...
			<div title="财务管理" data-options="iconCls:'icon-khgl'" style="padding: 10px;">
				<a href="javascript:openTab('保单帐户管理','securityManage.do','icon-khxxgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khxxgl'" style="width: 150px;">保单帐户管理</a>
				...
				<a href="javascript:openTab('保单流水账管理','tradeManage.do','icon-khlsgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khlsgl'" style="width: 150px;">保单流水账管理</a>
			</div>
